...
#define immJ() do { *imm = (SEXT(BITS(i, 30, 21), 13) << 1 | BITS(i, 20, 19) << 11 | BITS(i, 19, 12) << 12 | BITS(i, 31, 30) << 20);} while(0)
#define immR() do { } while(0)
#define immB() do { *imm = (SEXT(BITS(i, 11, 8), 4) << 1 | BITS(i, 30, 25) << 5 | BITS(i, 8, 7) << 11 | BITS(i, 31, 30) << 12);} while(0) 
