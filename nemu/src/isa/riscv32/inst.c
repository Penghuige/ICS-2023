...
INSTPAT_START();
  ...
  INSTPAT("0011000 00010 00000 000 00000 11100 11", mret   , R, printf("inst mepc is 0x%08x\n", cpu.csr.mepc); cpu.csr.prv = cpu.csr.mpp, cpu.csr.mpp = 0, cpu.csr.mie = cpu.csr.mpie, cpu.csr.mpie = 1;s->dnpc = cpu.csr.mepc; etrace_return(s));
