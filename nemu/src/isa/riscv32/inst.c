...
INSTPAT_START();
  ...
  INSTPAT("0011000 00010 00000 000 00000 11100 11", mret   , R, cpu.csr.prv = cpu.csr.mpp, cpu.csr.mpp = 0, cpu.csr.mie = cpu.csr.mpie, cpu.csr.mpie = 1;s->dnpc = cpu.csr.mepc + R(17) < 0 ? 4 : 0; etrace_return(s));
